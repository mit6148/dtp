...
function addToInvitationsTable(invitation) {
	...
	str = "";
	str += '<div class="ui segment">Invitation from <b>' + invitation.inviter.name + '</b> for <b>' + invitation.event.course + '</b><div id="invitationButtons"><div class="ui right floated red button" onclick="dismissInvitation(' + invitation.event_id + ')">Dismiss</div><div class="ui right floated green button" onclick="acceptInvitation(' + invitation.event_id + ')">Accept</div></div></div><div class="ui segments">';
	str += '<div class="ui horizontal segments"><div class="ui segment"> Assignment: ' + invitation.event.assignment + '</div><div class="ui segment"> Location: '+ invitation.event.location + '</div></div>';
